...
@WebServlet(urlPatterns = {"/manager/home", "/manager/category/add", "/manager/category/edit", 
                           "/manager/category/view", "/manager/category/delete"})
public class ManagerCategoryController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
        ...
        if (url.contains("/manager/home")) {
            showUserCategories(req, resp, user.getUserId());
        } else if (url.contains("/manager/category/add")) {
            req.getRequestDispatcher("/views/admin/category-add.jsp").forward(req, resp);
        } else if (url.contains("/manager/category/edit")) {
            showEditForm(req, resp, user.getUserId());
        } else if (url.contains("/manager/category/view")) {
            showCategoryDetail(req, resp, user.getUserId());
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
        ...
        if (url.contains("/manager/category/add")) {
    ...
    private void showUserCategories(HttpServletRequest req, HttpServletResponse resp, int userId) 
            throws ServletException, IOException {
    ...
    private void showCategoryDetail(HttpServletRequest req, HttpServletResponse resp, int userId) 
            throws ServletException, IOException {
        int id = Integer.parseInt(req.getParameter("id"));
        Category category = categoryService.findById(id);
